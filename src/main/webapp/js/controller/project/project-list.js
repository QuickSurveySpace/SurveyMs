    ...
    var MyController = {
        ...
        renderTable: function () {
            return $table.render({
                elem: '#project-list'
                , height: 'full-100'
                , url: projectApi.getUrl('projectList').url
                , method: 'post'
                , page: true
                , limits: [10, 50, 100, 200]
                , cols: [[
                    {type: 'numbers'},
                    {field: 'id', title: '项目ID', width: 80},
                    {field: 'title', title: '项目名称', width: 120},
                    {field: 'companyName', title: '公司名称', width: 120},
                    {field: 'completeNum', title: '已上传数量', width: 120},
                    {field: 'createUserId', title: '创建人', width: 100},
