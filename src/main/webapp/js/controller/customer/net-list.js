    ...
    var MyController = {
        ...
        renderTable: function () {
            return $table.render({
                elem: '#net-list'
                , height: 'full-100'
                , url: netApi.getUrl('netList').url
                , method: 'post'
                , page: true
                , limits: [10, 50, 100, 200]
                , cols: [[
                    {type: 'numbers'},
                    {field: 'id', title: '网点ID', width: 80},
                    {field: 'name', title: '网点名称', width: 120},
                    {field: 'addr', title: '网点地址', width: 300},
                    {field: 'phone', title: '网点电话', width: 120},
