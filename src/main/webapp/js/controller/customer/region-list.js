    ...
    var MyController = {
        ...
        renderTable: function () {
            return $table.render({
                elem: '#region-list'
                , height: 'full-100'
                , url: regionApi.getUrl('regionList').url
                , method: 'post'
                , page: true
                , limits: [10, 50, 100, 200]
                , cols: [[
                    {type: 'numbers'},
                    {field: 'id', title: '区域ID', width: 80},
                    {field: 'name', title: '区域名称', width: 120},
                    {field: 'companyName', title: '公司名称', width: 120},
                    {field: 'regionImg', title: '区域图片', width:100, templet: function (d) {
                        return "<a href='"+d.regionImg+"' target='_blank'><img src='"+d.regionImg+"' /></a>";
                    }},
